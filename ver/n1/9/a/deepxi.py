...
parser.add_argument('--ver', default='n1.9a', type=str, help='Model version')
...
parser.add_argument('--bidi', default=True, type=bool, help='Bidirectional recurrent neural network flag')
parser.add_argument('--bidi_con', default='add', type=str, help='Forward and backward cell activation connection')
