...
parser.add_argument('--retrain_epoch', default=175, type=int, help='Epoch to retrain from')
...
parser.add_argument('--test_epoch', default=175, type=int, help='Epoch for testing')
