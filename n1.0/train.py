...
# BRIEF:          Trains the non-causal ResBLSTM a-priori SNR estimator, 'DeepXi'.
...
print('DeepXi: ResBLSTM a priori SNR estimator')

## OPTIONS
version = 'n1.0' # model version.
...
bidi_connect = 'concat' # connection of forward and backward cell activations.
...
parser.add_argument('--bidi_connect', default=bidi_connect, type=str, help='Connection of forward and backward cell activations.')
